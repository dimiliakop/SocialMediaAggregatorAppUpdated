package com.example.socialmediaaggregatorupdate.UI.main.ui.create;
...
import com.example.socialmediaaggregatorupdate.API.Tasks.PublishPost;
                ...
                if (viewModel.getIsStorySelected().getValue() != null && !viewModel.getIsStorySelected().getValue()) {
                    ...
                    try {
                        ...
                        uploadImageToFirebase(mediaUri -> {
                            PublishPost task = new PublishPost(messageBody, mediaUri, platforms);
