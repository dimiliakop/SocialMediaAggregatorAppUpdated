...
import gr.uom.socialmediaaggregator.API.Tasks.GetFacebookData;
import gr.uom.socialmediaaggregator.API.Tasks.GetTwitterAuthToken;
                ...
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (snapshot != null) {
                            ...
                            if (!userExists) {
                                new GetTwitterAuthToken(v -> getFacebookDataAndChangeActivity()).execute();
                            } else {
